#ifndef MQL5_MOVING_AVERAGES_H
#define MQL5_MOVING_AVERAGES_H
...
//+------------------------------------------------------------------+
template<class T>
double ExponentialMA(const int position,const int period,const double prev_value,const T &price)
  {
//---
   double result=0.0;
//--- calculate value
...
//+------------------------------------------------------------------+
template<class T>
double SmoothedMA(const int position,const int period,const double prev_value,const T &price)
  {
//---
   double result=0.0;
//--- check position
...
//+------------------------------------------------------------------+
template<class T>
double LinearWeightedMA(const int position,const int period,const T &price)
  {
//---
...
int SimpleMAOnBuffer(const int rates_total,const int prev_calculated,const int begin,
                     const int period,const T &price,U &buffer)
  {
   int i,limit;
//--- check for data
...
int LinearWeightedMAOnBuffer(const int rates_total,const int prev_calculated,const int begin,
                             const int period,const T &price,U &buffer,int &weightsum)
  {
   int        i,limit;
   double     sum;
//--- check for data
